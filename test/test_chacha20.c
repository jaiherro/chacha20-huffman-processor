...
static int
test_chacha20_rfc8439_vector (void)
{
    ...
    ASSERT_EQUAL (chacha20_init (&ctx, key, nonce, 1), 0,
...
test_chacha20_symmetry (void)
{
    ...
    /* Encrypt */
    ASSERT_EQUAL (chacha20_init (&ctx, key, nonce, 0), 0,
                  "Encrypt init failed");
    ASSERT_EQUAL (
...
static int
test_chacha20_empty_input (void)
{
