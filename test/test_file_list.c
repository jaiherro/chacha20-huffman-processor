...
test_file_list_basic (void)
{
    ...
    ASSERT_EQUAL (file_list_add (&list, "input1.txt", "file1.txt", 1000, 500),
                  0, "Add 1 failed");
    ASSERT_EQUAL (file_list_add (&list, "input2.txt", "file2.doc", 2000, 1800),
                  0, "Add 2 failed");
...
/* Test save and load */
static int
test_file_list_persistence (void)
{
