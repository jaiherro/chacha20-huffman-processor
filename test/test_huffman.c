...
static int
create_test_file (const char *filename, const unsigned char *content,
                  size_t size)
{
...
static int
read_test_file (const char *filename, unsigned char *buffer, size_t buffer_size,
                size_t *bytes_read)
{
...
static long
get_test_file_size (const char *filename)
{
    FILE *file = fopen (filename, "rb");
    if (!file)
        return -1;
...
static int
test_huffman_basic_symmetry (void)
{
...
static int
test_huffman_single_character (void)
{
...
static int
test_huffman_repetitive_data (void)
{
...
static int
test_huffman_diverse_data (void)
{
...
static int
test_huffman_streaming_context (void)
{
    ...
    ASSERT_EQUAL (huffman_stream_init (&ctx), 0,
...
static int
test_huffman_error_conditions (void)
{
...
static int
test_huffman_worst_case_size (void)
{
