...
typedef struct
{
    ...
    unsigned long long next_sequence_num;
} file_list_t;
...
int file_list_add(file_list_t *list, const char *input_filename,
                  const char *output_filename, unsigned long long original_size,
                  unsigned long long processed_size);
...
unsigned long long file_list_get_recent(file_list_t *list, unsigned long long count,
                                        file_entry_t **result);
