...
#define DEBUG_ERROR(fmt, ...)                                                                           \
    ...
    {                                                                                                   \
        ...
        {                                                                                               \
            ...
            fprintf(stderr, "[%s ERROR] %s:%d: " fmt "\n", counter, __FILE__, __LINE__, ##__VA_ARGS__); \
        }                                                                                               \
    } while (0)
...
#define DEBUG_FREE(ptr) \
    DEBUG_TRACE("free: deallocating memory at %p", ptr)
...
#define DEBUG_CRYPTO_OP(op, input_size, output_size) \
    DEBUG_TRACE("crypto operation: %s, input: %lu bytes, output: %lu bytes", op, input_size, output_size)
